    ...
    <div className="min-h-screen bg-gradient-to-br from-green-100 via-lime-100 to-yellow-50 flex items-center justify-center p-6">
      <div className="max-w-5xl w-full bg-white/90 backdrop-blur-md rounded-3xl shadow-2xl p-10 border border-green-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="bg-green-50 rounded-2xl shadow-md p-6 border hover:shadow-xl transition-shadow">
            ...
            <Link
              ...
              className="inline-block px-6 py-3 bg-green-600 text-white font-medium rounded-full hover:bg-green-700 transition-transform transform hover:scale-105"
            >
              🚀 Book Now
            </Link>
          </div>
          ...
          <div className="bg-yellow-50 rounded-2xl shadow-md p-6 border hover:shadow-xl transition-shadow">
            ...
            <Link
              ...
              className="inline-block px-6 py-3 bg-yellow-500 text-white font-medium rounded-full hover:bg-yellow-600 transition-transform transform hover:scale-105"
            >
              📝 Register Now
            </Link>
          </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-10">
          <Link
            href="/about"
            className="px-6 py-2 bg-blue-600 text-white rounded-full hover:bg-blue-700 shadow-md transition-transform hover:scale-105"
          >
            📘 About Us
          </Link>
          ...
          <Link
            href="/contact"
            className="px-6 py-2 bg-indigo-600 text-white rounded-full hover:bg-indigo-700 shadow-md transition-transform hover:scale-105"
          >
            📞 Contact Us
          </Link>
          ...
          <Link
            href="/questions"
            className="px-6 py-2 bg-purple-600 text-white rounded-full hover:bg-purple-700 shadow-md transition-transform hover:scale-105"
          >
            🆘 Help
          </Link>
        </div>
